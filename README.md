...
<input type="Button" name="Button"
  ...
  <a href="https://idev.games/embed/orius-project-alpha-v3-0-2">Jouez</a>  
<BR><BR>
<input type="Button" name="Button3"
    value="Mohalia 3D" onClick=" ()" />    
   <a href="https://gamejolt.com/games/Mohalia/690634">Demo Download</a>
<BR><BR> 
 <CENTER>
   <img src="https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/e129cbda-4228-4e36-955c-1bdc3718e45c/d6bcdjf-d4f5da0b-83a8-4b4d-a342-8f40535ae84b.gif?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..zgy8omVwfzaAZ6iyfFHk1NBYD6fo3WHuNRaLrMVP3E8" height="200px" width="400px" /
</CENTER>
<BR><BR>
<input type="Button" name="Button2"
   value="Gamejolt"
      onClick="executeCommands(' + hasPARMS + ')" />
<a href="https://gamejolt.com/app">Telecharger L'application</a>                                                                              
<BR><BR>
<input type="Button" name="Button4"
   value="PlaySonLinux"
      onClick="executeCommands(' + hasPARMS + ')" />
<a href="https://playsonlinux.wixsite.com/play-son-linux">Playsonlinux</a>
<BR><BR>
<input type="Button" name="Button5"
   value="Site Officiel"
      onClick="executeCommands(' + hasPARMS + ')" />
<a href="https://www.rpgmakervx-fr.com/">Rpg Maker Mv</a>
  <BR><BR>
 <input type="Button" name="Button6"
   value="King-Evil sur gamejolt"
      onClick="executeCommands(' + hasPARMS + ')" />
<a href="https://steamcommunity.com/sharedfiles/filedetails/?id=3020968940">Découvrer le plugin RPG MAKER-MV3D ou MZ3D</a>
  <BR><BR>
 <input type="Button" name="Button6"
